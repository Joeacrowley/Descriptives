...
# project. Run with:
#
#   testthat::test_file(here::here("Scripts_new", "test_export_to_excel.R"))
#
...
source(here::here("Scripts_new", "export_to_excel.R"))
...
# these tests can't verify programmatically), not deleted on exit.
test_output_dir <- here::here("Scripts_new", "test_output")
